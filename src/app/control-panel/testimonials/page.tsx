                ...
                <AnimatePresence>
                    {testimonials.map((item, index) => (
                        <motion.div
                            ...
                            className={`relative bg-white rounded-2xl shadow-sm border p-5 ${item.isVisible ? "border-slate-200" : "border-red-200 opacity-60"
                                }`}
                        >
                            {/* Quote Icon */}
                            ...
                            {/* Content */}
                            <p className="text-sm text-slate-600 line-clamp-4 mb-4 italic">
                                "{item.content}"
                            </p>
                            ...
                            <div className="flex items-center gap-2 pt-3 border-t border-slate-100">
                                <Tooltip content="Edit">
                                    <button
                                        ...
                                        className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-sm text-slate-600 hover:bg-slate-50 transition-colors"
                                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className={`relative w-12 h-6 rounded-full transition-colors ${formData.isVisible ? "bg-teal-500" : "bg-slate-300"
                                }`}
                        >
                            <span
