        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
            ...
            >
                <div className="grid md:grid-cols-3">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-800/50 p-6 md:p-8 border-r border-slate-100 dark:border-slate-700">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-4">
                                ...
                                <p className="text-xs text-center text-slate-500 mt-3">
                                    By booking, you agree to our Terms of Service. Payment will be collected after service confirmation.
                                </p>
                            </div>
                        </form>
                    </div>
