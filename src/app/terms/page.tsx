    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center py-20 px-4">
            ...
            >
                ...
                >
                    <div className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm text-left">
                        <div className="h-10 w-10 shrink-0 rounded-lg bg-teal-100 text-teal-600 flex items-center justify-center">
                            <Scale className="h-5 w-5" />
                        </div>
                        <div>
                            <h3 className="font-semibold text-slate-900 mb-1">Fair Usage</h3>
                            <p className="text-sm text-slate-500">Guidelines on how to use our platform responsibly.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm text-left">
                        ...
                        <div>
                            <h3 className="font-semibold text-slate-900 mb-1">Service Level</h3>
                            <p className="text-sm text-slate-500">What you can expect from our caregivers and support.</p>
                        </div>
                    </div>

                    <div className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm text-left">
                        <div className="h-10 w-10 shrink-0 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center">
                            <ShieldAlert className="h-5 w-5" />
                        </div>
                        <div>
                            <h3 className="font-semibold text-slate-900 mb-1">Safety First</h3>
                            <p className="text-sm text-slate-500">Our commitment to the safety of all parties involved.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm text-left">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">How we handle disputes and provide assistance.</p>
                        </div>
                    </div>
                </MotionDiv>
